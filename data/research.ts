...
export const PRODUCT_RESEARCH: Record<string, ResearchStudy[]> = {
  ...
  'ipamorelin': [
    {
      ...
      summary: 'Characterises Ipamorelin as the first selective GHS-R1a agonist with potency comparable to GHRP-6 but without significant cortisol, prolactin, or ACTH stimulation.',
    },
    {
  ...
  'cjc-ipamorelin': [
    ...
    },
    {
      ...
      summary: 'Early study demonstrating that co-administration of GHRH and a GHRP produces a synergistic GH response significantly greater than either compound alone.',
    },
  ],
  ...
  'selank': [
    {
      ...
      summary: 'Reports Phase III clinical trial data demonstrating anxiolytic efficacy of Selank comparable to benzodiazepines with superior tolerability in anxiety disorders and neurasthenia.',
    },
    {
  ...
  'lumo-2-trz': [
    ...
    },
    {
      ...
      summary: 'Reviews the dual GIP/GLP-1 receptor agonism mechanism of Tirzepatide and Phase I/II clinical results demonstrating superior glycaemic and weight outcomes vs GLP-1 monotherapy.',
    },
  ],
  ...
  'lumo-3-rt': [
    ...
    {
      title: 'Efficacy of GLP-1 Analog Peptides on MC4R-Deficient Obesity',
      authors: 'Kim J, et al.',
      journal: 'PubMed (Epub)',
      year: 2025,
      pmid: '41723268',
      url: 'https://pubmed.ncbi.nlm.nih.gov/41723268/',
      summary: 'Comparative study showing Retatrutide, Tirzepatide, and Semaglutide all produce significant fat mass reduction and metabolic improvement via GLP-1 receptor pathways.',
    },
  ],
