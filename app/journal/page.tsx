      ...
      <div className="py-12 px-6" style={{ position: 'relative', overflow: 'visible' }}>
        <div className="container mx-auto max-w-7xl" style={{ position: 'relative', zIndex: 1 }}>
          ...
          <motion.div
            ...
            className="mb-6 font-mono text-xs uppercase tracking-mono text-[#1A1814]/80"
          >
          ...
          {filteredStudies.length > 0 ? (
              ...
              {filteredStudies.map((study, index) => (
                <motion.div key={study.url} variants={itemVariants}>
                  ...
                  >
                    ...
                    {/* Authors */}
                    <div className="text-[11px] text-[#1A1814]/80 mb-2">
                      {study.authors}
                    </div>

                    {/* Summary */}
                    <p
                      className="text-[12px] text-[#1A1814]/95 leading-relaxed flex-1"
                      style={{
                        display: "-webkit-box",
                        WebkitLineClamp: 3,
            ...
            >
              <p className="font-editorial text-lg text-[#1A1814]/80">
