...
export default function SignupPage() {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    if (password && confirmPassword !== password) { setConfirmError("Passwords do not match"); valid = false; }
    if (!ageConfirmed || !researchConfirmed) { setCheckboxError("Both confirmations are required to proceed"); valid = false; }
    if (!valid) return;
  ...
  const handleGoogleSignUp = async () => {
    ...
    if (!ageConfirmed || !researchConfirmed) {
      setCheckboxError("Please confirm both requirements before continuing with Google");
      return;
    }
      ...
      <div style={{ minHeight: "100vh", backgroundColor: "#F5EFE4" }}>
        <section style={{ backgroundColor: "#1A1814", padding: "28px 24px" }}>
          <div className="container mx-auto max-w-7xl">
            ...
            <h1 className="font-display" style={{ fontWeight: 300, fontStyle: "italic", fontSize: "clamp(2rem, 4vw, 3rem)", color: "#F5EFE4", letterSpacing: "-0.02em" }}>
              Check your inbox.
            </h1>
          </div>
        </section>
        <div style={{ padding: "64px 24px", maxWidth: "560px", margin: "0 auto" }}>
          <div style={{ backgroundColor: "#EBE2CF", borderLeft: "2px solid #607A5C", padding: "32px" }}>
            <div className="font-mono uppercase" style={{ fontSize: "9px", letterSpacing: "3px", color: "#607A5C", marginBottom: "12px" }}>
              ● CONFIRMATION SENT
            </div>
            <p className="font-editorial" style={{ fontSize: "15px", color: "#1A1814", lineHeight: 1.6, marginBottom: "16px" }}>
          ...
          <div style={{ marginTop: "24px" }}>
            <Link href="/login" className="font-mono uppercase" style={{ fontSize: "10px", letterSpacing: "2px", color: "#B8624A" }}>
              → Back to sign in
            </Link>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5" style={{ minHeight: "calc(100vh - 200px)" }}>
        ...
        >
          ...
          <div>
            ...
            >
              Join researchers<br />who demand<br />verified quality.
            </h2>

            <div style={{ display: "flex", flexDirection: "column", gap: "14px", marginBottom: "40px" }}>
              {[
                "Order history and lot tracking",
                "CoA downloads with every order",
                "Priority order support",
              ].map((item) => (
                <div key={item} style={{ display: "flex", alignItems: "flex-start", gap: "10px" }}>
                  <span style={{ color: "#C89A3C", fontSize: "6px", marginTop: "5px", flexShrink: 0 }}>●</span>
                  <span
                    className="font-mono uppercase"
            ...
            >
              <p
                className="font-mono uppercase"
                style={{ fontSize: "8px", letterSpacing: "1.5px", color: "#B8624A", lineHeight: 1.6 }}
              >
                Accounts are for qualified researchers purchasing compounds for legitimate in vitro research use only.
              </p>
            </div>
          </div>
        ...
        >
          <div style={{ width: "100%", maxWidth: "440px" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "20px" }}>
              ...
              <span className="font-mono uppercase" style={{ fontSize: "9px", letterSpacing: "2px", color: "#C89A3C" }}>or</span>
              <div style={{ flex: 1, height: "1px", backgroundColor: "#C89A3C", opacity: 0.35 }} />
            </div>
            ...
            <form onSubmit={handleSignUp} noValidate>
              ...
              <div style={{ marginBottom: "16px" }}>
                <label className="block font-mono uppercase" style={{ fontSize: "9px", letterSpacing: "2px", color: "#1A1814", marginBottom: "6px" }}>
                  Email address
                </label>
                <input
                  type="email"
                ...
                />
                {emailError && (
                  <p className="font-mono" style={{ fontSize: "10px", color: "#C0392B", marginTop: "5px" }}>{emailError}</p>
                )}
              </div>
              ...
              >
                <label style={{ display: "flex", alignItems: "flex-start", gap: "10px", cursor: "pointer" }}>
                  <input
                    ...
                    onChange={(e) => { setAgeConfirmed(e.target.checked); setCheckboxError(""); }}
                    style={{ marginTop: "2px", accentColor: "#B8624A", flexShrink: 0 }}
                  />
                  <span className="font-mono" style={{ fontSize: "10px", letterSpacing: "0.3px", color: "#1A1814", lineHeight: 1.5 }}>
                ...
                <label style={{ display: "flex", alignItems: "flex-start", gap: "10px", cursor: "pointer" }}>
                  <input
                    ...
                    onChange={(e) => { setResearchConfirmed(e.target.checked); setCheckboxError(""); }}
                    style={{ marginTop: "2px", accentColor: "#B8624A", flexShrink: 0 }}
                  />
                  <span className="font-mono" style={{ fontSize: "10px", letterSpacing: "0.3px", color: "#1A1814", lineHeight: 1.5 }}>
                    I confirm I am purchasing for legitimate research purposes only
                  </span>
                </label>
              </div>
              {checkboxError && (
                <p className="font-mono" style={{ fontSize: "10px", color: "#C0392B", marginBottom: "16px" }}>{checkboxError}</p>
              )}
            ...
            <div style={{ marginTop: "28px", paddingTop: "24px", borderTop: "1px solid rgba(26,24,20,0.1)" }}>
              <p className="font-editorial" style={{ fontSize: "13px", color: "#1A1814" }}>
                ...
                <Link href="/login" style={{ color: "#B8624A", textDecoration: "underline", textDecorationColor: "rgba(184,98,74,0.4)" }}>
                  Sign in
                </Link>
              </p>
            </div>
