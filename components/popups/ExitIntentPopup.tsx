...
export default function ExitIntentPopup({ onClose }: Props) {
  const [email, setEmail] = useState("");
  const [submitting, setSubmitting] = useState(false);
  const [done, setDone] = useState(false);

  const handleClose = () => {
    sessionStorage.setItem("lumo_exit_shown", "true");
    onClose();
  };
      ...
      >
        ...
        {done ? (
          ...
          <>
            ...
            >
              Research-grade starts with verified data.
            </h2>
            ...
            <form onSubmit={handleSubmit}>
              ...
              >
                ...
                >
                  {submitting ? "Sending…" : "→ GET LOT UPDATES"}
                </span>
              </button>
            </form>
          </>
