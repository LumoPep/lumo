...
export default function ResearchSection({ slug }: ResearchSectionProps) {
  ...
  return (
    <div className="mt-8 pt-8 border-t border-[#EBE2CF]">
      <h2 className="text-[10px] font-medium tracking-widest uppercase text-[#1A1814]/55 mb-4">
        RESEARCH
      </h2>
        ...
        {studies.map((study, index) => (
          ...
          >
            ...
            <div className="flex-1">
              ...
              <div className="text-[11px] text-[#1A1814]/55 mt-1">
                {study.authors} · {study.journal} · {study.year}
              </div>
              <div
                className="text-[12px] text-[#1A1814]/55 mt-1"
                style={{
                  display: '-webkit-box',
                  WebkitLineClamp: 2,
